...
import { getAllVouchers } from '../../api/accounts';
        ...
        <div className={s.card}>
          <div className={s.voucherCardHeader}>
            ...
            <div className={s.voucherFilters}>
              ...
              />
              <select
                id="accounts-voucher-status-filter"
                value={statusFilter}
              ...
              <label style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', fontSize: '0.8rem', color: '#6b7280', fontWeight: 600 }}>
                From
                <input
                  id="accounts-voucher-from-date-filter"
                  type="date"
              ...
              <label style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', fontSize: '0.8rem', color: '#6b7280', fontWeight: 600 }}>
                To
                <input
                  id="accounts-voucher-to-date-filter"
                  type="date"
                  value={dateToFilter}
